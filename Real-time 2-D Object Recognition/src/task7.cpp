...
- K = 3
- Here, header file included for k-means clustering , classifier
*/
...
int main( int argc, char** argv )
{
    ...
    src = imread("/home/ravina/Desktop/OpenCV/ObjectDetection/sample/assets/knife1.jpeg");
    ...
    //kmeans function called to predict and detect
    kmeans(finalFeature);
